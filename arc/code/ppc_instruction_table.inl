...
SIMPLE_INS(16, bc,     B|AA|LK, {FD_BO, FD_BI, FD_BD})
SIMPLE_INS(17, sc,     SC,{FD_LEV})
SIMPLE_INS(18, b,      I|AA|LK, {FD_LI})

EXTEND_INS(19, 0,   mcrf,  XL,  {FD_BF, FD_BFA})
EXTEND_INS(19, 16,  bclr,  XL|LK,  {FD_BO, FD_BI, FD_BH})
EXTEND_INS(19, 18,  rfid,  XL|B64)
...
EXTEND_INS(19, 274, hrfid, XL|B64)
...
EXTEND_INS(19, 528, bcctr, XL|LK,  {FD_BO, FD_BI, FD_BH})

SIMPLE_INS(20, rlwimi, M, {FD_RA, FD_RS, FD_SH, FD_MB, FD_ME})
SIMPLE_INS(21, rlwinm, M, {FD_RA, FD_RS, FD_SH, FD_MB, FD_ME})
SIMPLE_INS(23, rlwnm,  M, {FD_RA, FD_RS, FD_RB, FD_MB, FD_ME})

SIMPLE_INS(24, ori,  D, {FD_RA, FD_RS, FD_UI})
SIMPLE_INS(25, oris, D, {FD_RA, FD_RS, FD_UI})
SIMPLE_INS(26, xor,  D, {FD_RA, FD_RS, FD_UI})
SIMPLE_INS(27, xors, D, {FD_RA, FD_RS, FD_UI})
SIMPLE_INSP(28, andi,  D, {FD_RA, FD_RS, FD_UI})
SIMPLE_INSP(29, andis, D, {FD_RA, FD_RS, FD_UI})
...
EXTEND_INS(31, 75,  mulhw, XO,  {FD_RT, FD_RA, FD_RB})

EXTEND_INS(31, 19,   mfcr, XFX, {FD_RT})

EXTEND_INS(31, 20,  lwarx, X)   // No idea how its encoded
EXTEND_INS(31, 21,    ldx, X|B64,   {FD_RT, FD_RA, FD_RB})
EXTEND_INS(31, 23,   lwzx, X,   {FD_RT, FD_RA, FD_RB})
EXTEND_INS(31, 24,    slw, X,   {FD_RA, FD_RS, FD_RB})

EXTEND_INS(31, 26, cntlzw, X,   {FD_RA, FD_RS})
EXTEND_INS(31, 27,    sld, X|B64,   {FD_RA, FD_RS, FD_RB})
...
EXTEND_INS(31, 53,   ldux, X|B64,   {FD_RT, FD_RA, FD_RB})
EXTEND_INS(31, 54,  dcbst, X)   // Book II
EXTEND_INS(31, 55,  lwzux, X,   {FD_RT, FD_RA, FD_RB})
EXTEND_INS(31, 58, cntlzd, X|B64,   {FD_RA, FD_RS})
