...
internal char *
SPRFieldString(u32 SPR)
{
    char *Name = 0;
    switch(SPR)
    {
        case 1:   { Name = "xer"; } break;
        case 8:   { Name = "lr"; } break;
        case 9:   { Name = "ctr"; } break;
        case 18:  { Name = "dsisr"; } break;
        case 19:  { Name = "dar"; } break;
        case 26:  { Name = "srr0"; } break;
        case 27:  { Name = "srr1"; } break;
        case 268: { Name = "tb"; } break;
        case 269: { Name = "tbu"; } break;
        case 272: { Name = "sprg0"; } break;
        case 273: { Name = "sprg1"; } break;
        case 274: { Name = "sprg2"; } break;
        case 275: { Name = "sprg3"; } break;
        case 287: { Name = "pvr"; } break;
    }
...
enum instruction_flags
{
    ...
    InstructionFlag_L = (1 << 2),
    InstructionFlag_A = (1 << 3),
};
...
global_variable b32 Enable64BitInstructions = false;

internal void
DecompilePPC(loaded_file *File)
{
    // TODO:
        ...
        ++InstructionIndex)
    {
            ...
            ++SetIndex)
        {
            ...
            if(TestEncoding->Opcode == Opcode &&
               ...
               (Enable64BitInstructions || !(TestEncoding->Flags & INST_64)))
            {
        ...
        if(InstEncoding)
        {
            ...
            if(InstEncoding->Flags & INST_LK &&
               Instruction & 0x01)
            {
                Inst.Flags |= InstructionFlag_L;
            }

            if(InstEncoding->Flags & INST_AA &&
               Instruction & 0x02)
            {
                Inst.Flags |= InstructionFlag_A;
            }
                ...
                ++I)
            {
                ...
                if(Operand)
                {
                    ...
                    if(Encoding.Flags & FieldFlag_SpecialPurposeRegister)
                    {
                        OperandValue = ((OperandValue & 0x1f) << 5) | (OperandValue >> 5);
                    }
            ...
            if(Inst.Flags & InstructionFlag_L)
            {
                Inst.MnemonicName[MnemonicLength++] = 'l';
            }
            if(Inst.Flags & InstructionFlag_A)
            {
                Inst.MnemonicName[MnemonicLength++] = 'a';
            }
                ...
                ++I)
            {
                ...
                switch(Op.Type)
                {
                    ...
                    {
                        printf("\033[34m");
                        u64 Base = (Inst.Flags & InstructionFlag_A) ? 0 : Address;
                        LastPrinted = printf("0x%llx", Base + Op.Value);
                    }break;

                    case OperandType_SpecialPurposeRegister:
                    {
                        char *SPRName = SPRFieldString(Op.Value);
                        LastPrinted = SPRName ? printf("%s", SPRName) : printf("spr%d", Op.Value);
                    }break;
